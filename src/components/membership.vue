<template>
  <section>
    ...
    <div class="container px-5 text-center py-32 mx-auto">
      <p
    ...
    <div
      class="container px-5 grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 md:gap-6 flex-wrap lg:gap-16 gap-6 mx-auto md:-my-10 -my-16"
    >
      <div
